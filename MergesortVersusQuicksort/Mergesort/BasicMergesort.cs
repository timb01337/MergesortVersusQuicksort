...
public static class BasicMergesort
{
    public static void MergeSort(List<int> list)
    {
        ...
        MergeSort(left); //recursively continue splitting the left list
        MergeSort(right); //recursively continue splitting the right list
        
        Merge(list, left, right); //when splitting is done, sort and merge the two halves
    }
